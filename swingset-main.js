...
export async function createSwingsetRunner ({
  ...
  globalMeteringActive = false,
  meterVats = false,
  launchIndirectly = false,
  benchmarkRounds = 0,
  configPath = null,
  statsFile = null,
  dbDir = null,
  ...
  let bootstrapResult
  // kumavis: this seemed to be missing, important if omitting --init
